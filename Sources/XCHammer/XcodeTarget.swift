...
public class XcodeTarget: Hashable, Equatable {
    ...
    lazy var settings: XCBuildSettings = {
        ...
        func extractSwiftVersion() -> String? {
            // First look through the swiftcopts to see if `-swift-version <version>` has been specified
            ...
            // Second respect swift language version if explicitly defined
            ...
            if self.attributes[.has_swift_dependency] != nil || self.attributes[.has_swift_info] != nil {
                ...
                return try? ShellOut.shellOut(to: "xcrun swiftc -version | cut -d ' ' -f4")
            }
